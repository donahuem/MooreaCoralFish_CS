...
seep_dist <- read.csv("https://raw.githubusercontent.com/dbarnas/Natural_environmental_gradients_alter_community_composition_and_functional_diversity_on_coral_reefs/refs/heads/main/Data/Plate_Distance_to_Seep.csv") %>% 
  filter(Location == "Varari")
depth <- read.csv("https://raw.githubusercontent.com/dbarnas/Natural_environmental_gradients_alter_community_composition_and_functional_diversity_on_coral_reefs/refs/heads/main/Data/Adj_Sandwich_Depth.csv")
clod <- read.csv("data/Clod_Cards.csv")
turb <- read_csv("https://raw.githubusercontent.com/dbarnas/Natural_environmental_gradients_alter_community_composition_and_functional_diversity_on_coral_reefs/refs/heads/main/Data/Biogeochem/Turb_NC.csv")
...
chart.Correlation(nut_no_seep[,c(sd_columns)])
```
