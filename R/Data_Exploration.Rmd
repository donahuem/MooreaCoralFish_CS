...
growth_v_sp_plot_all <- ggplot(data = na.omit(BW_long), aes(y = `Pocillopora acuta`, x = `Porites rus`)) +
  geom_point() +
  labs(title = "Percent Change in Buoyant Weight by Species") +
  coord_fixed()+
  theme_linedraw() +
...
ggsave(filename = "../output/growth_v_sp_plot.png", plot = growth_v_sp_plot)
ggsave(filename = "../output/growth_v_sp_plot_all1.png",width = 5, height = 4 * (1/aspect_ratio), plot = growth_v_sp_plot_all)
```
