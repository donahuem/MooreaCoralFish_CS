...
PAC_cv_low_symb_model_dredge_model.avg = model.avg(PAC_cv_low_symb_model_dredge, delta < 10)
...
PAC_symb_cv_plus_lowtide_model <- lmer(Percent_Change ~ 
                       ...
                       (1 | Genotype) + (1 | Cage_Uncaged), 
                                 data = PAC_model_data, 
                                 na.action = na.pass)
plot(allEffects(PAC_cv_plus_lowtide_model))
```
