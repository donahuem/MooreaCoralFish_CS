...
PAC_meta$Cage_Uncaged[PAC_meta$Placement_Code == 'PAC V01 A'] <- 'A'
PAC_meta$Cage_Uncaged[PAC_meta$Placement_Code == 'PAC V01 B'] <- 'B'
PAC_meta$Cage_Uncaged[PAC_meta$Placement_Code == 'T0'] <- 'T0'
PAC_meta <- PAC_meta[-72, ]
write.csv(PAC_meta, "data/PAC_Coral_Codes.csv")
...
meta <- meta[!is.na(meta$Placement_Code), ]
meta$Cage_Uncaged <- as.factor(meta$Cage_Uncaged)

meta$Cage_Uncaged[meta$Placement_Code == 'PAC V01 A'] <- 'A'
meta$Cage_Uncaged[meta$Placement_Code == 'PAC V01 B'] <- 'B'

#make a master data
data <- left_join(meta, BW)
```
## Buoyant Weight
### Data Exploration:
