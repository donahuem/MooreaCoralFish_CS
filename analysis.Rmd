...
SI_join <- SI[,c("HS","δ15N", "δ13C", "Placement_Code","Pin_Number", "Cage_Uncaged", "Genotype", "Species", "CowTagID", "Δ15N", "Δ13C", "C_N_ratio", "Percent_N","Percent_C")] %>%
  pivot_wider(names_from = HS, values_from = c("δ15N", "δ13C", "C_N_ratio", "Percent_N","Percent_C"), names_sep = "_")
...
#### PC of response?
```{r}
pca.data <-na.omit( PRU_response_data[,c("Percent_Change", "FSC.Events_per_cm_2", "Δ15N","Δ13C",  "δ15N_host","δ15N_symb", "δ13C_host", "δ13C_symb", "C_N_ratio_host","C_N_ratio_symb", "Percent_N_host", "Percent_N_symb","Percent_C_host","Percent_C_symb")])
...
## NS RECCOMMENDS TO DO THIS ANOVA RUNNING WITH RE OF PIN NUMBER
...
car::Anova(model)
effect_plot <- ggpredict(model, terms = "Low_Tide_Mean_Phosphate_umolL[all]")
